<template>
  <div
    class="bg-white text-dark fixed top-0 right-0 h-screen"
      ...
      <div class="">
        ...
        >
          ...
          <img
            ...
            alt="Photo"
            id="photo"
            class="rounded-full h-28 w-28 object-cover shadow"
          />
        </div>
